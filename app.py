...
# Full Featured Frontend UI (Proxy Free)
    ...
    <body class="bg-blue-50 font-sans pb-24">
        ...
        <div class="bg-[#007bff] text-white p-4 flex justify-between items-center shadow-md">
            <div class="flex items-center space-x-2">
                ...
                <div>
                    ...
                    <span id="ip-status" class="text-[10px] text-blue-200">Direct Connection</span>
                </div>
            </div>
        ...
        <div class="max-w-md mx-auto p-4 space-y-4">
            ...
            <div class="bg-white p-5 rounded-2xl shadow-md">
                ...
                <div class="space-y-3">
                    ...
                    <button onclick="loginAcc()" class="w-full bg-[#007bff] text-white p-3 rounded-xl font-bold shadow hover:bg-blue-600 transition text-sm">Login (Direct)</button>
                </div>
        ...
        <script>
            ...
            async function loginAcc() {
                ...
                status.innerText = "Logging in directly...";
